                    ...
                    <?php foreach ($job_array as $values) {
                      if ($values['withdrawal'] == "0") { ?>
                        <tr style="width:100%;">
                          ...
                          <td style="vertical-align: middle; width:10%;"><?= $values['jobname'] ?></td>
                          ...
                          <td style="vertical-align: middle;">
                            <button onclick="location.href='/matching/interview?id=<?= $values['office_id'] ?>&jobname=<?= $values['jobname'] ?>&job_id=<?= $values['job_id'] ?>'" id="button1" type="submit" class="btn-primary">マッチング申し込み <i class="fas fa-envelope"></i></button>
                          </td>
                          <td style="vertical-align: middle;">
