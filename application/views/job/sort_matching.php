        ...
        <div class="row mb-2">
          ...
          <div class="col-4">
            <select name="jobs" class="form-control" style="width: 100%;">
              <?php if (!empty($job_array[0]['job'])) { ?>
                <option><?= $job_array[0]['job'] ?></option>
              <?php } else { ?>
                <option></option>
              <?php } ?>
                    ...
                    <?php foreach ($job_array as $values) {
                      if ($values['withdrawal'] == "0") { ?>
                        <tr>
                          ...
                          <td>
                            <button name="delete_job" data-id="<?= $values['office_id'] ?>" data-name="<?= $values['work'] ?>" type="submit" class="btn-danger">お気に入り <i class="fas fa-heart"></i></button>
                          </td>
                        </tr>
                      <?php  } ?>
                    <?php  } ?>
