                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <p><strong>求人名：</strong><?= $job_array['jobname'] ?></p>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <?php if (empty($favorite_array)) { ?>
                      <div class="form-group">
                        <button name="resister_favorite" data-id="<?= $job_array['office_id'] ?>" data-name="<?= $job_array['office'] ?>" type="submit" class="btn btn-primary btn-block mt-2">お気に入り登録 <i class="fas fa-heart"></i></button>
                      </div><!-- /.form-group -->
                    <?php } else { ?>
                      <div class="form-group">
                        <button name="release_favorite" data-id="<?= $job_array['office_id'] ?>" data-name="<?= $job_array['office'] ?>" type="submit" class="btn btn-danger btn-block mt-2">お気に入り解除 <i class="fas fa-heart"></i></button>
                      </div><!-- /.form-group -->
                    <?php } ?>
                  </div><!-- /.col -->
                </div><!-- /.row -->
