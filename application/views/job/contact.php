  ...
  <div class="register-box">
    ...
    <div class="card">
      <div class="card-body register-card-body">
        ...
        <p class="text-group mb-3">事業所名</span> : <strong><?= $row_array['team'] ?></strong></p>
        <p class="text-group mb-3">担当名　 <span class="fas fa-user"></span> : <strong><?= $row_array['skipper'] ?></strong></p>
        ...
        <div class="form-group mb-3">
          <textarea name="message" id="message" cols="40" rows="15" placeholder="※ここにメッセージを入力してください"></textarea>
        </div>
        <div class="row">
          <button id="contact" type="submit" class="btn btn-primary btn-block">送信する</button>
        </div>
        <br>
        <p><?= anchor('main/jobs', '一覧に戻る　>>'); ?></p>
      </div>
      <!-- /.form-box -->
    </div><!-- /.card -->
  </div>
