  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <h1 class="m-0 text-dark">登録ユーザー一覧</h1>
                        ...
                        <?php foreach ($office_array as $office) {
                          if ($office['withdrawal'] === "0") { ?>
                            <tr>
                              ...
                              <td>
                                <button name="stop_office" data-id="<?= $office['id'] ?>" data-name="<?= $office['office'] ?>" type="submit" class="btn-danger">利用停止 <i class="far fa-trash-alt"></i></button>
                              </td>
                            </tr>
                          <?php  } ?>
                        <?php  } ?>
                        ...
                        <?php foreach ($worker_array as $worker) {
                          if ($worker['withdrawal'] === "0") { ?>
                            <tr>
                              ...
                              <td>
                                <button onclick="location.href='/manager/worker_detail?id=<?= $worker['id'] ?>'" id="button3" type="submit" class="btn-success">詳細 <i class="fas fa-list"></i></button>
                              </td>
                              <td>
                                <button name="stop_worker" data-id="<?= $worker['id'] ?>" data-name="<?= $worker['name'] ?>" type="submit" class="btn-danger">利用停止 <i class="far fa-trash-alt"></i></button>
                              </td>
                            </tr>
                          <?php  } ?>
                        <?php  } ?>
