          ...
          <div class="col-12">
            <div class="card-body register-card-body">
              ...
              <div class="form-check form-check-inline">
                <input type="checkbox" class="form-check-input" name="user[]" value="office">
                <label class="form-check-label" for="office">事業者向け</label>
              </div>
              <div class="form-check form-check-inline">
                <input type="checkbox" class="form-check-input" name="user[]" value="worker">
                <label class="form-check-label" for="worker">求職者向け</label>
              </div>
              <div class="error">
              ...
              <div class="form-group mb-3">
                <textarea name="message" id="message" style="width:100%" rows="20" placeholder="※ここに内容を入力してください">
                

※こちらのメールは送信専用です。返信はお控え下さいますよう、よろしくお願いします。</textarea>
              </div>
              <div class="row">
