  ...
  <nav class="main-header sticky-top navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      <li class="nav-item d-none d-sm-block">
        <p class="nav-link">ようこそ<span class="text-primary"><?= $_SESSION['office'] ?></span>様</p>
      </li>
      <li class="nav-item">
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="<?= base_url() ?>main/workers" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="<?= base_url() ?>favorite/office_favorite" class="nav-link">
              <i class="nav-icon far fa-circle text-info"></i>
              <p>お気に入り</p>
              <i class="right fas fa-angle-right"></i>
            </a>
          ...
          <li class="nav-item has-treeview">
            <a href="<?= base_url() ?>chat/worker_list" class="nav-link">
              <i class="nav-icon far fa-circle text-info"></i>
              <p>チャット</p>
              <i class="right fas fa-angle-right"></i>
            </a>
          ...
          <li class="nav-item has-treeview">
            <a href="<?= base_url() ?>partner/office_matching" class="nav-link">
              <i class="nav-icon far fa-circle text-info"></i>
              <p>マッチング</p>
              <i class="right fas fa-angle-right"></i>
            </a>
          ...
          <li class="nav-item has-treeview">
            <a href="<?= base_url() ?>office/mypage" class="nav-link">
              <i class="nav-icon far fa-circle text-danger"></i>
              <p>マイページ</p>
              <i class="right fas fa-angle-right"></i>
            </a>
          ...
          <li class="nav-item">
            <a href="<?= base_url() ?>main/supports" class="nav-link">
