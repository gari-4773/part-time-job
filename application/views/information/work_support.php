    ...
    <div class="card">
      <div class="card-body register-card-body">
        ...
        <div class="input-group">
          <input type="hidden" class="form-control" name="worker_id" placeholder="店番" value="<?= $_SESSION['id'] ?>">
        </div>
        <div class="input-group">
          <input type="hidden" class="form-control" name="name" placeholder="監督名" value="<?= $_SESSION['name'] ?>">
        </div>
        <div class="input-group">
        ...
        <br>
        <p><?= anchor('worker/workers', '一覧に戻る　>>'); ?></p>
      </div>
      <!-- /.form-box -->
    </div><!-- /.card -->
  </div>
